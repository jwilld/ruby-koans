...
class AboutObjects < Neo::Koan
  ...
  def test_objects_can_be_inspected
    ...
    # single and double quotes do not matter
    assert_equal 'nil', nil.inspect
  end

  def test_every_object_has_an_id
    obj = Object.new
    # the class of the object's id is an integer
  ...
  def test_clone_creates_a_different_object
    # cloning an object creates a new, unqique object
    obj = Object.new
    copy = obj.clone
